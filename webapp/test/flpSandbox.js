		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#idstringzstringmethods-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idstringzstringmethods-display": {
								"semanticObject": "idstringzstringmethods",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idstring.zstringmethods",
									"url": sap.ui.require.toUrl("idstring/zstringmethods")
								}
							}
						}
					}
